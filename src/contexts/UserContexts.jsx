...
export const UserContextProvider = (props) => {
  ...
  const register = async (nombre, apellido, correo, contrasena, telefono, sexo, birthdate) => {
    //startLoading();
    try {

      await axios.post("/auth/signup", { nombre, apellido, correo, contrasena, telefono, sexo, birthdate });
